...
<head>
  ...
  <meta name="description" content="TCAN1051HVD CAN Transceiver Module hardware documentation and downloads">
  <title>TCAN1051HVD CAN Transceiver Module | Hardware Resources</title>
  <style>
    :root {{
      --ink: #17202a;
      --muted: #667085;
...
<body>
  <header class="site-header">
    <div class="header-content">
      <p class="eyebrow">UNIT Electronics · UE0085</p>
      <h1>TCAN1051HVD CAN Transceiver Module</h1>
